...
class InventoryAdmin(ctk.CTk):
    def __init__(self):
        ...
        self.column_configs = [
            {"text": "Photo", "width": 50, "padx": (22, 20)},
            {"text": "Code", "width": 50, "padx": (0, 20), "textlength": 100},
            {"text": "Name", "width": 100, "padx": (0, 20), "textlength": 100},
            {"text": "Category", "width": 95, "padx": (0, 20), "textlength": 100},
            {"text": "Price", "width": 60, "padx": (0, 25), "textlength": 50},
            {"text": "Type", "width": 60, "padx": (0, 15), "textlength": 50},
            {"text": "Brand", "width": 100, "padx": (0, 15), "textlength": 50},
            {"text": "Unit", "width": 50, "padx": (0, 20), "textlength": 50},
            {"text": "Stock", "width": 60, "padx": (0, 15), "textlength": 100},
            {"text": "Min.", "width": 50, "padx": (0, 15), "textlength": 100},
            {"text": "Stock Status", "width": 110, "padx": (0, 10)},
            {"text": "Actions", "width": 120, "padx": (0, 15), "textlength": 100},
        ]
    ...
    def on_mouse_scroll(self, event):
        ...
        scroll_speed = 10  # The higher the faster
    ...
    # def focus_in_search_pane(self, event):
    #     self.search_pane.configure(border_color="#298753")
    ...
    def setup_searchbar(self):
        ...
        # self.search_pane.bind("<FocusIn>", self.focus_in_search_pane)
    ...
    def filter_and_sort_products(self):
        ...
        if sort_by != "Sort by":
            ...
            self.reset_searchbar_button.configure(fg_color="#298753",hover_color="#4BAC76", state="normal")
        elif status != "Status":
            self.reset_searchbar_button.configure(fg_color="#298753",hover_color="#4BAC76", state="normal")
        elif query != "":
            self.reset_searchbar_button.configure(fg_color="#298753",hover_color="#4BAC76", state="normal")
        ...
        if query:
            ...
            if not filtered:
                ...
                self.no_result_label.pack(pady=20)
    ...
    def convert_blob_to_image(self, blob_data, product_id):
        try:
            ...
            # fallback_image = Image.open("icons/placeholder_image_original.png").resize((50, 50))
            # fallback_ctk_image = ctk.CTkImage(light_image=fallback_image, dark_image=fallback_image, size=(50, 50))
